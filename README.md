...
2. Assignment SQL Queries 
3. Entity diangram and pseudo code 

To import the Database 
mysql -u -hds -p < ANGELA.sql
all SQL included in the submission has been tested and runs without errors.
